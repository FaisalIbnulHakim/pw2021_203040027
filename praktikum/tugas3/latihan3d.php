...
<body>
	<table>
	    ...
	    <?php foreach ($pemainBola as $urutan => $pemain) : ?>
	        <tr>
	            <td><?= $urutan+1; ?></td>
	            <td class="nama"><?= $pemain["nama"]; ?></td>
	            <td class="club"><?= $pemain["club"]; ?></td>
	            <td class="main"><?= $pemain["jumlah main"]; ?></td>
	            <td class="gol"><?= $pemain["jumlah gol"]; ?></td>
	            <td class="assist"><?= $pemain["jumlah assist"]; ?></td>
	        </tr>
	    <?php endforeach; ?>
