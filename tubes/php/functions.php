...
function hapus($id)
{
    ...
    if ($gr['gambar'] != 'nophoto.png') {
        unlink('../assets/img/' . $gr['gambar']);
    }
    mysqli_query($conn, "DELETE FROM gaminggear WHERE id = $id") or die(mysqli_error($conn));
...
function cari($keyword)
{
    ...
    $query = "SELECT * FROM gaminggear WHERE 
          nama LIKE '%$keyword%' ";
